...
export default function PressReleasesPage() {
  ...
  const pressReleases = [
    {
      id: 1,
      title: 'PRIV Releases "living a lie" - Latest Single Explores Authenticity',
      category: 'Single Release',
      date: '2025-07-10',
      excerpt: 'Grand Rapids alternative artist PRIV returns with introspective new single exploring self-deception...',
      keywords: ['priv', 'single release', 'alternative', 'new music', 'living a lie', 'grand rapids'],
      seoScore: 95,
      views: 12420
    },
    {
      id: 2,
      title: 'PRIV\'s "victim" Reaches 100K Streams',
      category: 'Achievement',
      date: '2024-12-01',
      excerpt: 'PRIV\'s emotionally charged single "victim" hits major streaming milestone...',
      keywords: ['priv', 'victim', 'streaming', 'milestone', 'alternative music'],
      seoScore: 92,
      views: 8350
    },
    {
