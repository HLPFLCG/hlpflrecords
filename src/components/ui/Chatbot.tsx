...
export function Chatbot() {
  ...
  const botResponses = {
    ...
    about_hlpfl: [
      ...
      "Let me tell you about HLPFL! 🌟 We're a nonprofit that believes in the power of authentic music. Since 2009, we've been discovering incredible talent and helping them reach their full potential. We've pioneered new approaches to artist development with our 'tools, not contracts' philosophy. We're not just about the music - we're about building legacies. Interested in learning about our unique artist development programs?",
      "HLPFL represents the pinnacle of artist development! We've been in the game since 2009, and in that time, we've perfected our approach to nurturing talent. Our secret? We combine traditional music industry expertise with cutting-edge digital strategies. Our dedicated team works tirelessly to ensure every artist gets personalized attention. We distribute music across all major streaming platforms worldwide. Curious about our global reach?"
    ],
    artist_submission: [
    ...
    artists: [
      ...
      "The artists at HLPFL are like family! 👨‍👩‍👧‍👦 We work with a select roster of talented artists, each bringing something special to the table. Our artists represent the future of independent music. We take pride in our artist development - our artists have grown exponentially in skill and reach since joining us. The best part? Our artists actively collaborate with each other, creating amazing cross-genre projects. Which genre of music are you most passionate about?",
    ...
    founder: [
      "Ah, let me tell you about our incredible founder! 🌟 James Rockel started HLPFL in 2009 with a simple but powerful mission: to provide independent artists with tools and resources they need to succeed. With over 17 years in the music industry, he's seen everything from the rise of streaming to the pandemic's impact on live music. His philosophy has always been about building sustainable careers, not just chasing hits. He's personally involved in artist development and mentors musicians directly. What's really special is his background in both music production and business strategy - this unique combination helped shape HLPFL's artist-first approach. Would you like to know more about his vision?",
