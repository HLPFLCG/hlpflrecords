...
export function Chatbot() {
  ...
  const botResponses = {
    ...
    contact: [
      "I'd love to connect you with the right people at HLPFL Records! 📞 You have several options: For artist submissions and general inquiries, use our contact form on the website. For urgent matters, email us at contact@hlpfl.org. You can also continue chatting with me - I'm here 24/7! Our team typically responds within 24-48 hours. If you're an artist looking to submit music, make sure to include your SoundCloud/Spotify links and a brief bio. For business partnerships or press inquiries, mention that in your subject line. What type of connection are you looking to make?",
